...
def register():
    ...
    return render_template('register.html', title='Register', form=form, rule= rule)
...
def account():
    ...
    return render_template('account.html', title='Account',
                           image_file=image_file, form=form, rule= rule)
...
def user_posts(username):
    ...
    return render_template('user_posts.html', posts=posts, user=user, rule= rule)
